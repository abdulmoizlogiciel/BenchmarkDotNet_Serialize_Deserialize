...
namespace ConsoleAppNC_BenchmarkDotNet
{
    ...
    {
        private readonly Regex _regex = new("subscribe", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.RightToLeft);
        private static readonly Regex _regexTimeout = new("subscribe", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.RightToLeft, TimeSpan.FromMilliseconds(3));
